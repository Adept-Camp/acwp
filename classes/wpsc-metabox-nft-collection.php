...
class WPSC_MetaboxNFTCollection {
  ...
  static public function getMetaboxNFTArgs() {
    ...
    $args = [
      ...
      'nft-marketplace-auction' =>  __('NFT Buy&Sell and Auction Marketplace', 'wp-smart-contracts'),
      ...
      'nft-auction-tooltip' => __('Owners of NFT can auction their tokens in the Marketplace, and any interested user can buy', 'wp-smart-contracts'),
      ...
      'marketplace-security' =>  __('Security Options', 'wp-smart-contracts'),
