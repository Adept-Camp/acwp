...
HELP;
	...
	if (!WPSC_helpers::valArrElement($_COOKIE, "nft_ipfs_notice_hide")) {
		...
		<h1>IPFS support and much more!</h1>
		<p>Fixes and new features:</p>	
		<p>&raquo; Support to IPFS decentralized storage service for media. Learn more on how to: <a href="https://wpsmartcontracts.com/docs/doc-settings.php" target="_blank">Setup your IPFS account</a></li> and <a href="https://wpsmartcontracts.com/docs/doc-item-ipfs.php" target="_blank">store your assets on IPFS</a>.</p>
		<p>&raquo; Connects to Binance Smart Chain if Metamask is not present</p>
		<p>&raquo; Other minor fixes</p>
